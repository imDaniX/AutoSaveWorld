...
public class FTPClient extends FTP {
    ...
    public boolean setFileType(int fileType) throws IOException {
        return FTPReply.isPositiveCompletion(type(fileType));
    }

    public boolean setFileType(int fileType, int formatOrByteSize) throws IOException {
        return FTPReply.isPositiveCompletion(type(fileType, formatOrByteSize));
    }

    public boolean setFileStructure(int structure) throws IOException {
        return FTPReply.isPositiveCompletion(stru(structure));
    }

    public boolean setFileTransferMode(int mode) throws IOException {
        return FTPReply.isPositiveCompletion(mode(mode));
    }
