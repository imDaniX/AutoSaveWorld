...
package autosaveworld.zlibs.com.google.api.client.json.jackson2;

import autosaveworld.zlibs.com.google.api.client.json.JsonFactory;
import autosaveworld.zlibs.com.google.api.client.json.JsonGenerator;
import autosaveworld.zlibs.com.google.api.client.json.JsonParser;
import autosaveworld.zlibs.com.google.api.client.json.JsonToken;
...
public final class JacksonFactory extends JsonFactory {
     ...
     * JSON factory.
     */
    private final autosaveworld.zlibs.com.fasterxml.jackson.core.JsonFactory factory =
            new autosaveworld.zlibs.com.fasterxml.jackson.core.JsonFactory();

    {
        ...
        factory.configure(
                autosaveworld.zlibs.com.fasterxml.jackson.core.JsonGenerator.Feature.AUTO_CLOSE_JSON_CONTENT, false);
    }
    ...
    public JsonGenerator createJsonGenerator(OutputStream out, Charset enc) throws IOException {
        return new JacksonGenerator(
                this, factory.createJsonGenerator(out, autosaveworld.zlibs.com.fasterxml.jackson.core.JsonEncoding.UTF8));
    }
    ...
    static JsonToken convert(autosaveworld.zlibs.com.fasterxml.jackson.core.JsonToken token) {
        if (token == null) {
            return null;
        }
        switch (token) {
