...
public abstract class DriveRequest<T> extends autosaveworld.zlibs.com.google.api.client.googleapis.services.json.AbstractGoogleJsonClientRequest<T> {
     ...
     *                      {@link autosaveworld.zlibs.com.google.api.client.http.UriTemplate#expand(String, String, Object, boolean)}
     ...
     */
    @autosaveworld.zlibs.com.google.api.client.util.Key("oauth_token")
    ...
    @Override
    public DriveRequest<T> setRequestHeaders(autosaveworld.zlibs.com.google.api.client.http.HttpHeaders headers) {
