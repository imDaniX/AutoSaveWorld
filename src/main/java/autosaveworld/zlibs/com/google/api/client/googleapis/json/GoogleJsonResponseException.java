...
package autosaveworld.zlibs.com.google.api.client.googleapis.json;

import autosaveworld.zlibs.com.google.api.client.http.HttpMediaType;
...
import autosaveworld.zlibs.com.google.api.client.json.Json;
...
public class GoogleJsonResponseException extends HttpResponseException {
    ...
    public static GoogleJsonResponseException from(JsonFactory jsonFactory, HttpResponse response) {
        ...
        if (!autosaveworld.zlibs.com.google.api.client.util.Strings.isNullOrEmpty(detailString)) {
