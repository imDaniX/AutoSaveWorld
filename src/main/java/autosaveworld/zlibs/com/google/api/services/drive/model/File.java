...
public final class File extends autosaveworld.zlibs.com.google.api.client.json.GenericJson {
     ...
     */
    @autosaveworld.zlibs.com.google.api.client.util.Key
    @autosaveworld.zlibs.com.google.api.client.json.JsonString
     ...
     */
    @autosaveworld.zlibs.com.google.api.client.util.Key
    private autosaveworld.zlibs.com.google.api.client.util.DateTime lastViewedByMeDate;
     ...
     */
    @autosaveworld.zlibs.com.google.api.client.util.Key
    private autosaveworld.zlibs.com.google.api.client.util.DateTime markedViewedByMeDate;
     ...
     */
    @autosaveworld.zlibs.com.google.api.client.util.Key
    private autosaveworld.zlibs.com.google.api.client.util.DateTime modifiedByMeDate;
     ...
     */
    public File setCreatedDate(autosaveworld.zlibs.com.google.api.client.util.DateTime createdDate) {
     ...
     * @return value or {@code null} for none
     */
    public autosaveworld.zlibs.com.google.api.client.util.DateTime getLastViewedByMeDate() {
     ...
     */
    public File setLastViewedByMeDate(autosaveworld.zlibs.com.google.api.client.util.DateTime lastViewedByMeDate) {
     ...
     * @return value or {@code null} for none
     */
    public autosaveworld.zlibs.com.google.api.client.util.DateTime getMarkedViewedByMeDate() {
     ...
     */
    public File setMarkedViewedByMeDate(autosaveworld.zlibs.com.google.api.client.util.DateTime markedViewedByMeDate) {
     ...
     * @return value or {@code null} for none
     */
    public autosaveworld.zlibs.com.google.api.client.util.DateTime getModifiedByMeDate() {
     ...
     */
    public File setModifiedByMeDate(autosaveworld.zlibs.com.google.api.client.util.DateTime modifiedByMeDate) {
     ...
     */
    public File setModifiedDate(autosaveworld.zlibs.com.google.api.client.util.DateTime modifiedDate) {
     ...
     * @return value or {@code null} for none
     */
    public autosaveworld.zlibs.com.google.api.client.util.DateTime getSharedWithMeDate() {
     ...
     */
    public File setSharedWithMeDate(autosaveworld.zlibs.com.google.api.client.util.DateTime sharedWithMeDate) {
     ...
     * depend on what can be parsed from the image content.
     */
    public static final class ImageMediaMetadata extends autosaveworld.zlibs.com.google.api.client.json.GenericJson {
         ...
         * Geographic location information stored in the image.
         */
        public static final class Location extends autosaveworld.zlibs.com.google.api.client.json.GenericJson {
     ...
     * Indexable text attributes for the file (can only be written)
     */
    public static final class IndexableText extends autosaveworld.zlibs.com.google.api.client.json.GenericJson {
     ...
     * A group of labels for the file.
     */
    public static final class Labels extends autosaveworld.zlibs.com.google.api.client.json.GenericJson {
     ...
     * Google.
     */
    public static final class Thumbnail extends autosaveworld.zlibs.com.google.api.client.json.GenericJson {
        ...
        public byte[] decodeImage() {
            return autosaveworld.zlibs.com.google.api.client.util.Base64.decodeBase64(image);
        }
        ...
        public Thumbnail encodeImage(byte[] image) {
            this.image = autosaveworld.zlibs.com.google.api.client.util.Base64.encodeBase64URLSafeString(image);
            return this;
        }
     ...
     * Metadata about video media. This will only be present for video types.
     */
    public static final class VideoMediaMetadata extends autosaveworld.zlibs.com.google.api.client.json.GenericJson {
