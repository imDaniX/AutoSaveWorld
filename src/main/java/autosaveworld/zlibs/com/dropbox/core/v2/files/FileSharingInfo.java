...
public class FileSharingInfo extends SharingInfo {
    ...
    static class Serializer extends StructSerializer<FileSharingInfo> {
        ...
        @Override
        public void serialize(FileSharingInfo value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public FileSharingInfo deserialize(JsonParser p, boolean collapsed) throws IOException {
