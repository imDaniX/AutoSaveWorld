...
public class DeleteBatchResult {
    ...
    static class Serializer extends StructSerializer<DeleteBatchResult> {
        ...
        @Override
        public void serialize(DeleteBatchResult value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public DeleteBatchResult deserialize(JsonParser p, boolean collapsed) throws IOException {
