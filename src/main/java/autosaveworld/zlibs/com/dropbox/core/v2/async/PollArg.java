...
package autosaveworld.zlibs.com.dropbox.core.v2.async;
...
public class PollArg {
    ...
    public static class Serializer extends StructSerializer<PollArg> {
        ...
        @Override
        public void serialize(PollArg value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public PollArg deserialize(JsonParser p, boolean collapsed) throws IOException {
            PollArg value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
