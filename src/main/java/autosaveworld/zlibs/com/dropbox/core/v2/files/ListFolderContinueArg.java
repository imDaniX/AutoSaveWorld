...
class ListFolderContinueArg {
    ...
    static class Serializer extends StructSerializer<ListFolderContinueArg> {
        ...
        @Override
        public void serialize(ListFolderContinueArg value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public ListFolderContinueArg deserialize(JsonParser p, boolean collapsed) throws IOException {
