...
public final class DeleteBatchJobStatus {
    ...
    static class Serializer extends UnionSerializer<DeleteBatchJobStatus> {
        ...
        @Override
        public void serialize(DeleteBatchJobStatus value, JsonGenerator g) throws IOException {
            switch (value.tag()) {
                case IN_PROGRESS: {
        ...
        @Override
        public DeleteBatchJobStatus deserialize(JsonParser p) throws IOException {
