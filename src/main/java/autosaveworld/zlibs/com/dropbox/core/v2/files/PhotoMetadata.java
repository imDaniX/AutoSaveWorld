...
public class PhotoMetadata extends MediaMetadata {
    ...
    static class Serializer extends StructSerializer<PhotoMetadata> {
        ...
        @Override
        public void serialize(PhotoMetadata value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
            writeTag("photo", g);
        ...
        @Override
        public PhotoMetadata deserialize(JsonParser p, boolean collapsed) throws IOException {
            PhotoMetadata value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
