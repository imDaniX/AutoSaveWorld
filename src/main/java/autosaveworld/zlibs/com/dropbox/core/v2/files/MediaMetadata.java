...
public class MediaMetadata {
    ...
    static class Serializer extends StructSerializer<MediaMetadata> {
        ...
        @Override
        public void serialize(MediaMetadata value, JsonGenerator g, boolean collapse) throws IOException {
        ...
        @Override
        public MediaMetadata deserialize(JsonParser p, boolean collapsed) throws IOException {
            MediaMetadata value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
