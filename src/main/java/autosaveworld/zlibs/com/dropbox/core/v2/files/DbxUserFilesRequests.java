...
public class DbxUserFilesRequests {
     ...
     */
    FolderMetadata createFolder(CreateFolderArg arg) throws DbxException {
        try {
     ...
     *                                  preconditions.
     */
    public FolderMetadata createFolder(String path, boolean autorename) throws DbxException {
     ...
     */
    Metadata delete(DeleteArg arg) throws DbxException {
        try {
            return this.client.rpcStyle(this.client.getHost().getApi(),
                    "2/files/delete",
                    arg,
     ...
     *                                  preconditions.
     */
    public Metadata delete(String path) throws DbxException {
     ...
     */
    LaunchEmptyResult deleteBatch(DeleteBatchArg arg) throws DbxException {
        try {
            return this.client.rpcStyle(this.client.getHost().getApi(),
     ...
     *                                  preconditions.
     */
    public LaunchEmptyResult deleteBatch(List<DeleteArg> entries) throws DbxException {
     ...
     *            job.
     */
    DeleteBatchJobStatus deleteBatchCheck(PollArg arg) throws DbxException {
        try {
            return this.client.rpcStyle(this.client.getHost().getApi(),
     ...
     *                                  preconditions.
     */
    public DeleteBatchJobStatus deleteBatchCheck(String asyncJobId) throws DbxException {
     ...
     * @return Metadata for a file or folder.
     */
    Metadata getMetadata(GetMetadataArg arg) throws DbxException {
        try {
            return this.client.rpcStyle(this.client.getHost().getApi(),
     ...
     */
    ListFolderResult listFolder(ListFolderArg arg) throws DbxException {
        try {
            return this.client.rpcStyle(this.client.getHost().getApi(),
                    "2/files/list_folder",
                    arg,
     ...
     */
    ListFolderResult listFolderContinue(ListFolderContinueArg arg) throws DbxException {
        try {
            return this.client.rpcStyle(this.client.getHost().getApi(),
     ...
     * exist in Dropbox.
     */
    ListFolderGetLatestCursorResult listFolderGetLatestCursor(ListFolderArg arg) throws DbxException {
        try {
            return this.client.rpcStyle(this.client.getHost().getApi(),
     ...
     *                                  preconditions.
     */
    public ListFolderGetLatestCursorResult listFolderGetLatestCursor(String path) throws DbxException {
        ListFolderArg _arg = new ListFolderArg(path);
