...
public abstract class Dumpable {
     ...
     * </p>
     *
     * @param currentIndent The number of spaces to use as the initial indentation level.
     * @param nl            Whether you will start displaying this value on its own line (and will need indentation
    ...
    protected /*@Nullable*/String getTypeName() {
        return null;
    }
