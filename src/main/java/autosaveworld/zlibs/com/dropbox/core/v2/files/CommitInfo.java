...
public class CommitInfo {
    ...
    static class Serializer extends StructSerializer<CommitInfo> {
        ...
        @Override
        public void serialize(CommitInfo value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public CommitInfo deserialize(JsonParser p, boolean collapsed) throws IOException {
            CommitInfo value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
