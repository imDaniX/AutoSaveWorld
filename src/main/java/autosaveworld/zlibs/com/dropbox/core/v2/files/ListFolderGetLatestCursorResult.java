...
public class ListFolderGetLatestCursorResult {
    ...
    static class Serializer extends StructSerializer<ListFolderGetLatestCursorResult> {
        ...
        @Override
        public void serialize(ListFolderGetLatestCursorResult value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public ListFolderGetLatestCursorResult deserialize(JsonParser p, boolean collapsed) throws IOException {
