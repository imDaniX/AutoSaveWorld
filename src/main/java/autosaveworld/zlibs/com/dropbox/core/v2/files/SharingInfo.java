...
public class SharingInfo {
    ...
    private static class Serializer extends StructSerializer<SharingInfo> {
        ...
        @Override
        public void serialize(SharingInfo value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public SharingInfo deserialize(JsonParser p, boolean collapsed) throws IOException {
            SharingInfo value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
