...
public class DeletedMetadata extends Metadata {
    ...
    static class Serializer extends StructSerializer<DeletedMetadata> {
        ...
        @Override
        public void serialize(DeletedMetadata value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
            writeTag("deleted", g);
        ...
        @Override
        public DeletedMetadata deserialize(JsonParser p, boolean collapsed) throws IOException {
