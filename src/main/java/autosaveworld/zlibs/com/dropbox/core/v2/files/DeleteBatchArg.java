...
class DeleteBatchArg {
    ...
    static class Serializer extends StructSerializer<DeleteBatchArg> {
        ...
        @Override
        public void serialize(DeleteBatchArg value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public DeleteBatchArg deserialize(JsonParser p, boolean collapsed) throws IOException {
