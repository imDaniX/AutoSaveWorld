...
public class UploadSessionFinishArg {
    ...
    static class Serializer extends StructSerializer<UploadSessionFinishArg> {
        ...
        @Override
        public void serialize(UploadSessionFinishArg value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public UploadSessionFinishArg deserialize(JsonParser p, boolean collapsed) throws IOException {
