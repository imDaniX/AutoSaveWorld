...
public class PathRootError {
    ...
    public static class Serializer extends StructSerializer<PathRootError> {
        ...
        @Override
        public void serialize(PathRootError value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public PathRootError deserialize(JsonParser p, boolean collapsed) throws IOException {
            PathRootError value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
