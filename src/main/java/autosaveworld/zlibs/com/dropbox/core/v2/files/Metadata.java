...
public class Metadata {
    ...
    static class Serializer extends StructSerializer<Metadata> {
        ...
        @Override
        public void serialize(Metadata value, JsonGenerator g, boolean collapse) throws IOException {
        ...
        @Override
        public Metadata deserialize(JsonParser p, boolean collapsed) throws IOException {
            Metadata value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
