...
public class FileMetadata extends Metadata {
    ...
    static class Serializer extends StructSerializer<FileMetadata> {
        ...
        @Override
        public void serialize(FileMetadata value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
            writeTag("file", g);
        ...
        @Override
        public FileMetadata deserialize(JsonParser p, boolean collapsed) throws IOException {
            FileMetadata value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
