...
public enum WriteConflictError {
    ...
    static class Serializer extends UnionSerializer<WriteConflictError> {
        ...
        @Override
        public void serialize(WriteConflictError value, JsonGenerator g) throws IOException {
            switch (value) {
                case FILE: {
                    g.writeString("file");
                    break;
        ...
        @Override
        public WriteConflictError deserialize(JsonParser p) throws IOException {
