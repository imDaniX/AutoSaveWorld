...
public class UploadSessionCursor {
    ...
    static class Serializer extends StructSerializer<UploadSessionCursor> {
        ...
        @Override
        public void serialize(UploadSessionCursor value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public UploadSessionCursor deserialize(JsonParser p, boolean collapsed) throws IOException {
