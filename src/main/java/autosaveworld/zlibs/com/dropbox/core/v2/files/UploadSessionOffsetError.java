...
public class UploadSessionOffsetError {
    ...
    static class Serializer extends StructSerializer<UploadSessionOffsetError> {
        ...
        @Override
        public void serialize(UploadSessionOffsetError value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public UploadSessionOffsetError deserialize(JsonParser p, boolean collapsed) throws IOException {
