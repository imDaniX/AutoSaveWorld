...
public class DeleteResult {
    ...
    static class Serializer extends StructSerializer<DeleteResult> {
        ...
        @Override
        public void serialize(DeleteResult value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public DeleteResult deserialize(JsonParser p, boolean collapsed) throws IOException {
            DeleteResult value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
