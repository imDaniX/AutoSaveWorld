...
import autosaveworld.zlibs.com.dropbox.core.v2.properties.PropertyGroup;
...
public class FolderMetadata extends Metadata {
    ...
    static class Serializer extends StructSerializer<FolderMetadata> {
        ...
        @Override
        public void serialize(FolderMetadata value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
            writeTag("folder", g);
        ...
        @Override
        public FolderMetadata deserialize(JsonParser p, boolean collapsed) throws IOException {
