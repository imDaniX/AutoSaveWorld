...
import autosaveworld.zlibs.com.dropbox.core.DbxRequestUtil;
import autosaveworld.zlibs.com.dropbox.core.DbxWrappedException;
import autosaveworld.zlibs.com.dropbox.core.NetworkIOException;
import autosaveworld.zlibs.com.dropbox.core.RetryException;
...
import static autosaveworld.zlibs.com.dropbox.core.DbxRequestUtil.addUserLocaleHeader;
...
public abstract class DbxRawClientV2 {
     ...
     * that does <b>not</b> retry 500 errors ({@link autosaveworld.zlibs.com.dropbox.core.ServerException}). To maintain
