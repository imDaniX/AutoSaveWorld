...
public class FolderSharingInfo extends SharingInfo {
    ...
    static class Serializer extends StructSerializer<FolderSharingInfo> {
        ...
        @Override
        public void serialize(FolderSharingInfo value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public FolderSharingInfo deserialize(JsonParser p, boolean collapsed) throws IOException {
