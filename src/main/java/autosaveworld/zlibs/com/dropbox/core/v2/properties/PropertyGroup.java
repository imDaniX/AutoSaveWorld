...
public class PropertyGroup {
    ...
    public static class Serializer extends StructSerializer<PropertyGroup> {
        ...
        @Override
        public void serialize(PropertyGroup value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public PropertyGroup deserialize(JsonParser p, boolean collapsed) throws IOException {
            PropertyGroup value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
