...
public class Dimensions {
    ...
    static class Serializer extends StructSerializer<Dimensions> {
        ...
        @Override
        public void serialize(Dimensions value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public Dimensions deserialize(JsonParser p, boolean collapsed) throws IOException {
            Dimensions value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
