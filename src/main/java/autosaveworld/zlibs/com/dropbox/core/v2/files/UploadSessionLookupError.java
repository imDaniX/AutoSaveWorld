...
public final class UploadSessionLookupError {
    ...
    static class Serializer extends UnionSerializer<UploadSessionLookupError> {
        ...
        @Override
        public void serialize(UploadSessionLookupError value, JsonGenerator g) throws IOException {
            switch (value.tag()) {
                case NOT_FOUND: {
        ...
        @Override
        public UploadSessionLookupError deserialize(JsonParser p) throws IOException {
