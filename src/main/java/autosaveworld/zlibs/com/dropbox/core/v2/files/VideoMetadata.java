...
public class VideoMetadata extends MediaMetadata {
    ...
    static class Serializer extends StructSerializer<VideoMetadata> {
        ...
        @Override
        public void serialize(VideoMetadata value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
            writeTag("video", g);
        ...
        @Override
        public VideoMetadata deserialize(JsonParser p, boolean collapsed) throws IOException {
            VideoMetadata value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
