...
public class DeleteArg {
    ...
    static class Serializer extends StructSerializer<DeleteArg> {
        ...
        @Override
        public void serialize(DeleteArg value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public DeleteArg deserialize(JsonParser p, boolean collapsed) throws IOException {
            DeleteArg value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
