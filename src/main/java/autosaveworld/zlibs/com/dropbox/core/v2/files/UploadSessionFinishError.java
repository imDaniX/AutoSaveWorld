...
public final class UploadSessionFinishError {
    ...
    static class Serializer extends UnionSerializer<UploadSessionFinishError> {
        ...
        @Override
        public void serialize(UploadSessionFinishError value, JsonGenerator g) throws IOException {
            switch (value.tag()) {
                case LOOKUP_FAILED: {
                    g.writeStartObject();
        ...
        @Override
        public UploadSessionFinishError deserialize(JsonParser p) throws IOException {
