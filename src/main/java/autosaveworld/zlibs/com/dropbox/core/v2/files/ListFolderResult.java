...
public class ListFolderResult {
    ...
    static class Serializer extends StructSerializer<ListFolderResult> {
        ...
        @Override
        public void serialize(ListFolderResult value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public ListFolderResult deserialize(JsonParser p, boolean collapsed) throws IOException {
