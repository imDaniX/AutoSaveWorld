...
public class UploadWriteFailed {
    ...
    static class Serializer extends StructSerializer<UploadWriteFailed> {
        ...
        @Override
        public void serialize(UploadWriteFailed value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public UploadWriteFailed deserialize(JsonParser p, boolean collapsed) throws IOException {
