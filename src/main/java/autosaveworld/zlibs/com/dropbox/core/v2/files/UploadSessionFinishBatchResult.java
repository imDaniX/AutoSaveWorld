...
public class UploadSessionFinishBatchResult {
    ...
    static class Serializer extends StructSerializer<UploadSessionFinishBatchResult> {
        ...
        @Override
        public void serialize(UploadSessionFinishBatchResult value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public UploadSessionFinishBatchResult deserialize(JsonParser p, boolean collapsed) throws IOException {
