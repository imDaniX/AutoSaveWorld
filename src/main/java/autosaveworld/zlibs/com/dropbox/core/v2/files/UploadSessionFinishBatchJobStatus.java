...
public final class UploadSessionFinishBatchJobStatus {
    ...
    static class Serializer extends UnionSerializer<UploadSessionFinishBatchJobStatus> {
        ...
        @Override
        public void serialize(UploadSessionFinishBatchJobStatus value, JsonGenerator g) throws IOException {
            switch (value.tag()) {
                case IN_PROGRESS: {
        ...
        @Override
        public UploadSessionFinishBatchJobStatus deserialize(JsonParser p) throws IOException {
