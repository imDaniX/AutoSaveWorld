...
public class PropertyField {
    ...
    static class Serializer extends StructSerializer<PropertyField> {
        ...
        @Override
        public void serialize(PropertyField value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public PropertyField deserialize(JsonParser p, boolean collapsed) throws IOException {
            PropertyField value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
