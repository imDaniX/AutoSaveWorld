...
public final class StoneSerializers {
    ...
    private static final class LongSerializer extends StoneSerializer<Long> {
        ...
        @Override
        public void serialize(Long value, JsonGenerator g) throws IOException {
            g.writeNumber(value);
        }

        @Override
        public Long deserialize(JsonParser p) throws IOException {
    ...
    private static final class IntSerializer extends StoneSerializer<Integer> {
        ...
        @Override
        public void serialize(Integer value, JsonGenerator g) throws IOException {
            g.writeNumber(value);
        }

        @Override
        public Integer deserialize(JsonParser p) throws IOException {
    ...
    private static final class DoubleSerializer extends StoneSerializer<Double> {
        ...
        @Override
        public void serialize(Double value, JsonGenerator g) throws IOException {
            g.writeNumber(value);
        }

        @Override
        public Double deserialize(JsonParser p) throws IOException {
    ...
    private static final class FloatSerializer extends StoneSerializer<Float> {
        ...
        @Override
        public void serialize(Float value, JsonGenerator g) throws IOException {
            g.writeNumber(value);
        }

        @Override
        public Float deserialize(JsonParser p) throws IOException {
    ...
    private static final class BooleanSerializer extends StoneSerializer<Boolean> {
        ...
        @Override
        public void serialize(Boolean value, JsonGenerator g) throws IOException {
            g.writeBoolean(value);
        }

        @Override
        public Boolean deserialize(JsonParser p) throws IOException {
    ...
    private static final class ByteArraySerializer extends StoneSerializer<byte[]> {
        ...
        @Override
        public void serialize(byte[] value, JsonGenerator g) throws IOException {
            g.writeBinary(value);
        }

        @Override
        public byte[] deserialize(JsonParser p) throws IOException {
    ...
    private static final class StringSerializer extends StoneSerializer<String> {
        ...
        @Override
        public void serialize(String value, JsonGenerator g) throws IOException {
            g.writeString(value);
        }

        @Override
        public String deserialize(JsonParser p) throws IOException {
    ...
    private static final class DateSerializer extends StoneSerializer<Date> {
        ...
        @Override
        public void serialize(Date value, JsonGenerator g) throws IOException {
            g.writeString(Util.formatTimestamp(value));
        }

        @Override
        public Date deserialize(JsonParser p) throws IOException {
    ...
    private static final class VoidSerializer extends StoneSerializer<Void> {
        ...
        @Override
        public void serialize(Void value, JsonGenerator g) throws IOException {
            g.writeNull();
        }

        @Override
        public Void deserialize(JsonParser p) throws IOException {
            skipValue(p);
            return null;
        }
    }
    ...
    private static final class ListSerializer<T> extends StoneSerializer<List<T>> {
        ...
        @Override
        public void serialize(List<T> value, JsonGenerator g) throws IOException {
        ...
        @Override
        public List<T> deserialize(JsonParser p) throws IOException {
            expectStartArray(p);
