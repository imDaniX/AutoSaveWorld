...
public final class UploadSessionFinishBatchResultEntry {
    ...
    static class Serializer extends UnionSerializer<UploadSessionFinishBatchResultEntry> {
        ...
        @Override
        public void serialize(UploadSessionFinishBatchResultEntry value, JsonGenerator g) throws IOException {
            switch (value.tag()) {
                case SUCCESS: {
                    g.writeStartObject();
                    writeTag("success", g);
        ...
        @Override
        public UploadSessionFinishBatchResultEntry deserialize(JsonParser p) throws IOException {
