...
public final class DeleteBatchResultEntry {
    ...
    static class Serializer extends UnionSerializer<DeleteBatchResultEntry> {
        ...
        @Override
        public void serialize(DeleteBatchResultEntry value, JsonGenerator g) throws IOException {
            switch (value.tag()) {
                case SUCCESS: {
                    g.writeStartObject();
                    writeTag("success", g);
        ...
        @Override
        public DeleteBatchResultEntry deserialize(JsonParser p) throws IOException {
