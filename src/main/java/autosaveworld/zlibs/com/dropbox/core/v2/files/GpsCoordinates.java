...
public class GpsCoordinates {
    ...
    static class Serializer extends StructSerializer<GpsCoordinates> {
        ...
        @Override
        public void serialize(GpsCoordinates value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public GpsCoordinates deserialize(JsonParser p, boolean collapsed) throws IOException {
