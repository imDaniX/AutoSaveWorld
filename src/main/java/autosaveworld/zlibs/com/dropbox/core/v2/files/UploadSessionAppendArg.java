...
class UploadSessionAppendArg {
    ...
    static class Serializer extends StructSerializer<UploadSessionAppendArg> {
        ...
        @Override
        public void serialize(UploadSessionAppendArg value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public UploadSessionAppendArg deserialize(JsonParser p, boolean collapsed) throws IOException {
