...
class CreateFolderArg {
    ...
    static class Serializer extends StructSerializer<CreateFolderArg> {
        ...
        @Override
        public void serialize(CreateFolderArg value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public CreateFolderArg deserialize(JsonParser p, boolean collapsed) throws IOException {
