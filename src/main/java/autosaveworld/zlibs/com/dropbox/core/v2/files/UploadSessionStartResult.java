...
public class UploadSessionStartResult {
    ...
    static class Serializer extends StructSerializer<UploadSessionStartResult> {
        ...
        @Override
        public void serialize(UploadSessionStartResult value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public UploadSessionStartResult deserialize(JsonParser p, boolean collapsed) throws IOException {
