...
public final class ListFolderContinueError {
    ...
    static class Serializer extends UnionSerializer<ListFolderContinueError> {
        ...
        @Override
        public void serialize(ListFolderContinueError value, JsonGenerator g) throws IOException {
            switch (value.tag()) {
                case PATH: {
                    g.writeStartObject();
                    writeTag("path", g);
        ...
        @Override
        public ListFolderContinueError deserialize(JsonParser p) throws IOException {
