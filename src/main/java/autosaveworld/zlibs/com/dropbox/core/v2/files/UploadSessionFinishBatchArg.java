...
class UploadSessionFinishBatchArg {
    ...
    static class Serializer extends StructSerializer<UploadSessionFinishBatchArg> {
        ...
        @Override
        public void serialize(UploadSessionFinishBatchArg value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public UploadSessionFinishBatchArg deserialize(JsonParser p, boolean collapsed) throws IOException {
