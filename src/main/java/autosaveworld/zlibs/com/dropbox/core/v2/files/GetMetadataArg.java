...
class GetMetadataArg {
    ...
    static class Serializer extends StructSerializer<GetMetadataArg> {
        ...
        @Override
        public void serialize(GetMetadataArg value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public GetMetadataArg deserialize(JsonParser p, boolean collapsed) throws IOException {
