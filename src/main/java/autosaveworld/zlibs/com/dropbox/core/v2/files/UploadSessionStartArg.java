...
class UploadSessionStartArg {
    ...
    static class Serializer extends StructSerializer<UploadSessionStartArg> {
        ...
        @Override
        public void serialize(UploadSessionStartArg value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public UploadSessionStartArg deserialize(JsonParser p, boolean collapsed) throws IOException {
