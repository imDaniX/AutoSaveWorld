...
class ListFolderArg {
    ...
    static class Serializer extends StructSerializer<ListFolderArg> {
        ...
        @Override
        public void serialize(ListFolderArg value, JsonGenerator g, boolean collapse) throws IOException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public ListFolderArg deserialize(JsonParser p, boolean collapsed) throws IOException {
            ListFolderArg value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
