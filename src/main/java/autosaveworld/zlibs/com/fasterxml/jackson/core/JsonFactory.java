        ...
        java.io.Serializable // since 2.1 (for Android, mostly)
{
     ...
     * if (and only if) {@link autosaveworld.zlibs.com.fasterxml.jackson.core.JsonParser.Feature#AUTO_CLOSE_SOURCE}
     * is enabled.
     * <p>
     * <p>
     ...
     * {@link JsonGenerator#close} is called (unless auto-closing
     * feature,
     * {@link autosaveworld.zlibs.com.fasterxml.jackson.core.JsonGenerator.Feature#AUTO_CLOSE_TARGET} is enabled).
